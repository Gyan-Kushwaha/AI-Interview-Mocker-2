...
export default function CodeEditor() {
  ...
  const handleAddFile = () => {
    ...
    setFiles([
      ...files,
      { name: newFileName, content: "", language: "JavaScript" },
    ]);
      ...
      <div className="flex flex-col h-screen bg-zinc-900 text-zinc-100">
        <div className="flex justify-between items-center p-4 text-white bg-zinc-800 border-b border-zinc-700">
          <Select
            ...
            value={files[activeFile].language}
          >
            ...
            <SelectContent className="bg-zinc-900 border-zinc-700">
              {languages.map((lang) => (
                <SelectItem className="text-gray-400" key={lang.id} value={lang.name}>
                  {lang.name}
                </SelectItem>
              ))}
            </SelectContent>
          ...
          <div>
            ...
            <Button
              onClick={handleShare}
              className="ml-2 bg-zinc-700 hover:bg-zinc-600"
            >
              Share Code
            </Button>
          </div>
